...
def is_swap(player_score, opponent_score):
    ...
    def product(x):
        ...
        while a <= x:
            ...
            leftist = x // a
            a = a * 10
        return leftist * rightest
    if product(player_score) == product(opponent_score):
        return True
    else:
        return False"""
    def product(x):
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score0 < goal and score1 < goal:
        if player == 0:
            ...
            if feral_hogs and abs(num0 - k0) == 2:
                score0 += 3
            player = other(player)
            k0 = num0
        else:
            ...
            if feral_hogs and abs(num1 - k1) == 2:
                score1 += 3
            player = other(player)
            k1 = num1
    ...
    # BEGIN PROBLEM 6
    """
    我用的2019 fall的材料，ok系统里的random test 这道题总有错误，不知道是代码问题还是给的数据有问题，所以删掉了。
    """
    # END PROBLEM 6
...
def announce_highest(who, previous_high=0, previous_score=0):
    ...
    def say(score0, score1):
        if who == 0:
            ...
            curr_score = score1
        difference = curr_score - previous_score
...
def max_scoring_num_rolls(dice=six_sided, num_samples=1000):
    ...
    n, highest = 1, 0
    while n <= 10:
        averaged_value = make_averaged(roll_dice, num_samples)(n, dice)
        if averaged_value > highest:
            op_roll = n
            highest = averaged_value
        n += 1
    return op_roll
    # END PROBLEM 9
...
def swap_strategy(score, opponent_score, margin=8, num_rolls=4):
    ...
    bacon_score = free_bacon(opponent_score)
    score += bacon_score
    swap = is_swap(score, opponent_score)
    if swap and score > opponent_score:
        return num_rolls
    elif (swap and score < opponent_score) or bacon_score >= margin:
        return 0
    else:
        return num_rolls
    # END PROBLEM 11
